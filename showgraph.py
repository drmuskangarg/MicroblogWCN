...
usertweet=dict()
dusertweet=dict()
usertweet={1: u'Hmm Sunday Mirror news ed @jasav is tweeting "confirmation" that Amy Winehouse has died.', 2: u'Maybe a rumour but Dean Piper appears to have tweeted that Amy Winehouse has died', 3: u'@jlscrazymad rumours amy winehouse has died- remains rumours'}
...
#abc=nx.draw_networkx(G,with_labels=True,arrows=True)
